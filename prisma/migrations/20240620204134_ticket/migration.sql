/*
  ...
  - You are about to drop the column `updatadAt` on the `Event` table. All the data in the column will be lost.
  - You are about to drop the column `updatadAt` on the `Spot` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `Event` DROP COLUMN `updatadAt`,
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `Spot` DROP COLUMN `updatadAt`,
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL,
    MODIFY `status` ENUM('available', 'reserved') NOT NULL;
